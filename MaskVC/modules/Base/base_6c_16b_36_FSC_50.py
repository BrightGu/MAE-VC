...
class ModuBlock(nn.Module):
    def __init__(self,c_in,c_hid,c_out):
        super(ModuBlock, self).__init__()

        self.handler = Handler(c_in, c_hid, c_out)
    ...
    def forward(self, x,spk_emb):
        ...
        out = self.modu(lat_x,lat_spk_emb)
...
class MagicModel(nn.Module):
    def __init__(self, d_model=256):
        ...
        self.modu4_mask = ModuBlock_mask(16, 36, 16,nhead =6)
        self.modu5_mask = ModuBlock_mask(16, 36, 16,nhead =6)
        self.modu6_mask = ModuBlock_mask(16, 36, 80,nhead =6)
    ...
    def forward(self, x1,x2):
        ...
        lat5 = self.modu5_mask(lat4, spk_emb, 50)
        lat6 = self.modu6_mask(lat5, spk_emb, 50)
        out = self.ge(lat6)
        return out
    ...
    def remove_weight_norm(self):
        ...
        self.modu5_mask.remove_weight_norm()
        self.modu6_mask.remove_weight_norm()
